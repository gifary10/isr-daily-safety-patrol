export class Findings {
    ...
    initEventListeners() {
        try {
            ...
            if (this.app.elements.findingCategory) {
                this.app.elements.findingCategory.addEventListener('change', () => {
                    if (this.app.elements.findingCategory.value === 'other') {
                        if (this.app.elements.otherCategoryContainer) {
                            this.app.elements.otherCategoryContainer.style.display = 'block';
                        }
                        if (this.app.elements.otherCategory) {
            ...
            console.error('Error initializing findings event listeners:', error);
        }
    }

    saveFinding() {
        if (!this.app.elements.findingForm) {
            console.error('Finding form not found');
            return;
        }
        ...
        try {
            ...
            if (this.app.elements.findingModal) {
        ...
        try {
            ...
            findingCard.innerHTML = `
                <div class="card-body">
                    ...
                    <p class="mt-2 finding-description">${finding.description || 'Tidak ada deskripsi'}</p>
