export class Navigation {
    ...
    initEventListeners() {
        try {
            ...
            console.error('Error initializing navigation event listeners:', error);
        }
    }

    showDashboard() {
        this.hideAllSections();
        if (this.app.elements.dashboardContent) {
    ...
    showReportDetail(reportId) {
        ...
        this.hideAllSections();
        if (this.app.elements.reportDetailContent) {
            this.app.elements.reportDetailContent.style.display = 'block';
            this.updateActiveNav(null); // No nav item active for detail view
            if (this.app.reportDetail) {
